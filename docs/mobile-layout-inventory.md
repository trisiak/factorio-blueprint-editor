...
| **Marquee bar** (`#marquee-bar`)      | **bottom-center** (same band as the d-pad)      | row of 64px buttons (Copy/Cut/Delete/Cancel) | **21**  | **Mobile + SELECT only**; the box-select action bar (#21). Same band/z as the d-pad — they never coexist                                                       |
